                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <input type="text" class="form-control" id="add-address" name="address" placeholder="Address">
                            ...
                            <div class="mb-3 col-md-6">
                              ...
                              <input type="date" class="form-control" id="add-date-of-birth" name="date_of_birth">
